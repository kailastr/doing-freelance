            ...
            <div>
                ...
                <div className='flex justify-center my-5 sticky top-24'>
                    <div className='flex border-2 bg-white border-red-600 rounded-full mx-auto text-md'>
                        <a href='/client/profile#profileView' className='hover:bg-red-100 px-5 py-3 rounded-full cursor-pointer transition duration-300 ease-in-out'>View Profile</a>
                        <a href='/client/profile#profileEdit' className='hover:bg-red-100 px-5 py-3 rounded-full cursor-pointer transition duration-300 ease-in-out'>Edit Profile</a>
                        <Link to={'/index'} onClick={SignOut}>
                            <p href='/index' className='hover:bg-red-100 px-5 py-3 rounded-full cursor-pointer transition duration-300 ease-in-out'>Sign Out</p>
                        </Link>
                    </div>
                </div>
                <div className='flex justify-center my-5' id='profileView'>
                ...
                <div className='w-full flex justify-center' id='profileEdit'>
                    <div className='w-6/12 bg-slate-200 my-10 rounded-md'>
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <input type="text" id='firstName' placeholder={user.FirstName} className='flex justify-start mx-5 mt-3 font-medium w-11/12 px-3 rounded-md py-2' />

                            <label htmlFor="middleName" className='flex justify-start mx-5 mt-3 font-medium'>Middle Name : </label>
                            <input type="text" id='middleName' placeholder={user.MiddleName} className='flex justify-start mx-5 mt-3 font-medium w-11/12 px-3 rounded-md py-2' />

                            <label htmlFor="lastName" className='flex justify-start mx-5 mt-3 font-medium'>Last Name : </label>
                            <input type="text" id='lastName' placeholder={user.LastName} className='flex justify-start mx-5 mt-3 font-medium w-11/12 px-3 rounded-md py-2' />

                            <label htmlFor="walletAddress" className='flex justify-start mx-5 mt-3 font-medium'>Wallet Address : </label>
                            <input type="text" id='walletAddress' placeholder={user.walletAddress} className='flex justify-start mx-5 mt-3 font-medium w-11/12 px-3 rounded-md py-2' />

                            <div className='mt-3'>
                                <label htmlFor="experienceLevel" className='flex justify-start mx-5 mt-3 font-medium'>Experience Level : </label>
                                <select id="experienceLevel" className='flex justify-start mx-5 mt-3 font-medium w-11/12 px-3 rounded-md py-2' value={experienceLevel} onChange={handleExperienceLevelChange}>
                            ...
                            <input type="text" id='portfolioLink' placeholder="https://...." className='flex justify-start mx-5 mt-3 font-medium w-11/12 px-3 rounded-md py-2' />

                            <div className='mt-3'>
                                <h3 className='font-medium mx-5'>Languages known</h3>
                                <div className='flex gap-2 mx-5 mt-3'>
                                    <input type="text" id='newLanguage' placeholder="Add new language" className='flex justify-start font-medium w-8/12 px-3 rounded-md py-2' />
                                    <button
                            ...
                            <div className='mt-3'>
                                ...
                                <div className='flex gap-2 mx-5 mt-3'>
                                    <input type="text" id='newskill' placeholder="Add new skill" className='flex justify-start font-medium w-8/12 px-3 rounded-md py-2' />
                                    <button
                                        className='mx-5 font-medium bg-slate-300 px-5 rounded-md'
