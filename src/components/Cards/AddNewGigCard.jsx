    ...
    return (
        <div className='w-11/12 bg-red-100 rounded-md my-5 shadow-lg'>
            <div className='flex justify-center'>
                <h3 className='my-3 text-xl font-semibold'>Fill Up Required Gig Details</h3>
            </div>
                ...
                <div className='flex flex-col gap-3 mx-10 my-3'>
                    ...
                    <div className='flex justify-between gap-3 my-3 mx-10'>
                        <div className='flex flex-row gap-3'>
                            <label htmlFor="price" className='font-medium text-gray-700 py-2'>Price </label>
                            <input type="text" id='price' name='price' className='rounded-md border border-gray-300 px-3 py-2 focus:outline-none focus:ring-1 focus:ring-blue-500 focus:ring-opacity-50 shadow-sm' placeholder='In USD₮' />
                        </div>
                        <div className='flex flex-row gap-3'>
                            <label htmlFor="location" className='font-medium text-gray-700 py-2'>Add Your location </label>
                            <input type="text" id='location' name='location' className='rounded-md border border-gray-300 px-3 py-2 focus:outline-none focus:ring-1 focus:ring-blue-500 focus:ring-opacity-50 shadow-sm' placeholder='Work/Company Location' />
                        </div>
                        <div className='flex flex-row gap-3'>
                            <label htmlFor="location" className='font-medium text-gray-700 py-2'>Add Deadline of your project </label>
                    ...
                    <div className='flex justify-center gap-3 my-3 mx-10'>
                        ...
                        <input type='reset' className='border-2 border-red-700 w-24 rounded-lg font-semibold hover:bg-red-200 transition duration-300 ease-in-out px-3 py-2' value={"Cancle"} />
                    </div>
                </div>
            </form>
        </div>
