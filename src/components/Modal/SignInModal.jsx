                                ...
                                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                                    ...
                                    <form action="">
                                        <div className='flex flex-col'>
                                            <label htmlFor="userName" className='text-lg font-semibold mt-3'>User Name : </label>
                                            <input type="text" id='userName' name='userName' className='mt-2 py-1 px-1 border-2 border-blue-400 rounded-md focus:outline-none focus:border-blue-700' placeholder='Enter your email as username' />
