                                ...
                                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                                    ...
                                    <form onSubmit={escrowProjectSubmit}>
                                        <div className='flex flex-col'>
                                            ...
                                            <label htmlFor="projectUrl" className='text-lg w-5/12 font-semibold my-1'>Project URL : </label>
                                            <input
                                                type="text"
                                                name="projectUrl"
                                                id="projectUrl"
                                            ...
                                            />
                                            <div className='my-3'>
                                                <button type='submit' className='text-lg font-semibold border border-blue-600 w-full py-2 my-3 rounded-md bg-blue-100 hover:bg-blue-200'>Submit Project</button>
                                            </div>
                                        </div>
                                    </form>
                                </Dialog.Panel>
